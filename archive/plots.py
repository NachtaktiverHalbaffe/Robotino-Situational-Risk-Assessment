...
print("probs adv:")
# for evaluation: calculates and prints the frequencies of chosen actions (for histogram)
# evaluate_logs.calc_probabilities(log_reader)

log_reader = CSV_Reader("adv_1", test_mode=False)
# rewards (for adversary) are per step instead of per episode -> choose bigger average window
evaluate_logs.plot_rewards("adv_1", log_reader, avg_window=3 * avg_window)
