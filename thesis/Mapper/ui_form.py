...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.Foward.setGeometry(QRect(540, 230, 91, 51))
        self.Backward = QPushButton(self.centralwidget)
        self.Backward.setObjectName(u"Backward")
        self.Backward.setGeometry(QRect(540, 350, 91, 51))
        self.Left = QPushButton(self.centralwidget)
        self.Left.setObjectName(u"Left")
        self.Left.setGeometry(QRect(440, 290, 91, 51))
        self.Right = QPushButton(self.centralwidget)
        self.Right.setObjectName(u"Right")
        self.Right.setGeometry(QRect(640, 290, 91, 51))
        self.Break = QPushButton(self.centralwidget)
        self.Break.setObjectName(u"Break")
        self.Break.setGeometry(QRect(540, 290, 91, 51))
        self.on_off_btn = QPushButton(self.centralwidget)
        self.on_off_btn.setObjectName(u"on_off_btn")
        self.on_off_btn.setGeometry(QRect(10, 10, 111, 51))
        self.gen_map_btn = QPushButton(self.centralwidget)
        self.gen_map_btn.setObjectName(u"gen_map_btn")
        self.gen_map_btn.setGeometry(QRect(290, 10, 111, 51))
        self.speed_dial = QDial(self.centralwidget)
        self.speed_dial.setObjectName(u"speed_dial")
        self.speed_dial.setGeometry(QRect(450, 210, 81, 71))
        font = QFont()
        font.setPointSize(11)
        self.speed_dial.setFont(font)
        ...
        self.start_rob_btn = QPushButton(self.centralwidget)
        self.start_rob_btn.setObjectName(u"start_rob_btn")
        self.start_rob_btn.setGeometry(QRect(150, 10, 111, 51))
        self.traj_btn = QPushButton(self.centralwidget)
        self.traj_btn.setObjectName(u"traj_btn")
        self.traj_btn.setGeometry(QRect(290, 130, 111, 51))
        self.log_data_btn = QPushButton(self.centralwidget)
        self.log_data_btn.setObjectName(u"log_data_btn")
        self.log_data_btn.setGeometry(QRect(10, 130, 111, 51))
        self.save_map_btn = QPushButton(self.centralwidget)
        self.save_map_btn.setObjectName(u"save_map_btn")
        self.save_map_btn.setGeometry(QRect(150, 130, 111, 51))
        self.custom_btn_4 = QPushButton(self.centralwidget)
        self.custom_btn_4.setObjectName(u"custom_btn_4")
        self.custom_btn_4.setGeometry(QRect(370, 440, 111, 51))
        self.speed_lcd = QLCDNumber(self.centralwidget)
        self.speed_lcd.setObjectName(u"speed_lcd")
        self.speed_lcd.setGeometry(QRect(430, 10, 101, 51))
        self.use_keyboard_chk = QCheckBox(self.centralwidget)
        self.use_keyboard_chk.setObjectName(u"use_keyboard_chk")
        self.use_keyboard_chk.setGeometry(QRect(610, 410, 121, 21))
        self.Speed_2 = QLabel(self.centralwidget)
        self.Speed_2.setObjectName(u"Speed_2")
        self.Speed_2.setGeometry(QRect(10, 90, 71, 21))
        self.map_display = QGraphicsView(self.centralwidget)
        self.map_display.setObjectName(u"map_display")
        self.map_display.setGeometry(QRect(10, 200, 421, 231))
        self.Auto_map_chk = QCheckBox(self.centralwidget)
        self.Auto_map_chk.setObjectName(u"Auto_map_chk")
        self.Auto_map_chk.setGeometry(QRect(420, 160, 111, 31))
        self.custom_btn_1 = QPushButton(self.centralwidget)
        self.custom_btn_1.setObjectName(u"custom_btn_1")
        self.custom_btn_1.setGeometry(QRect(10, 440, 111, 51))
        self.custom_btn_2 = QPushButton(self.centralwidget)
        self.custom_btn_2.setObjectName(u"custom_btn_2")
        self.custom_btn_2.setGeometry(QRect(130, 440, 111, 51))
        self.custom_btn_3 = QPushButton(self.centralwidget)
        self.custom_btn_3.setObjectName(u"custom_btn_3")
        self.custom_btn_3.setGeometry(QRect(250, 440, 111, 51))
        self.custom_btn_5 = QPushButton(self.centralwidget)
        self.custom_btn_5.setObjectName(u"custom_btn_5")
        self.custom_btn_5.setGeometry(QRect(490, 440, 111, 51))
        self.label = QLabel(self.centralwidget)
        self.label.setObjectName(u"label")
        self.label.setGeometry(QRect(630, 450, 81, 31))
        self.path_to_map = QLineEdit(self.centralwidget)
        self.path_to_map.setObjectName(u"path_to_map")
        self.path_to_map.setGeometry(QRect(80, 80, 451, 31))
        self.info_box = QTextEdit(self.centralwidget)
        self.info_box.setObjectName(u"info_box")
        self.info_box.setGeometry(QRect(540, 10, 191, 211))
        self.info_box.setReadOnly(True)
        self.Speed_3 = QLabel(self.centralwidget)
        self.Speed_3.setObjectName(u"Speed_3")
        self.Speed_3.setGeometry(QRect(450, 270, 31, 21))
        font1 = QFont()
        font1.setPointSize(9)
        font1.setItalic(True)
        self.Speed_3.setFont(font1)
        self.Speed_4 = QLabel(self.centralwidget)
        self.Speed_4.setObjectName(u"Speed_4")
        self.Speed_4.setGeometry(QRect(500, 270, 31, 21))
        self.Speed_4.setFont(font1)
        self.speed_real = QLCDNumber(self.centralwidget)
        self.speed_real.setObjectName(u"speed_real")
        self.speed_real.setGeometry(QRect(430, 130, 101, 31))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"IAS LOGO", None))
