...
avg_window = 200   # determines how many episodes are averaged in plots
...
log_reader = CSV_Reader('adv_1', test_mode=True)
#log_reader_1 = CSV_Reader('adv_2', test_mode=True)
...
#evaluate_logs.plot_collisions_dual('adv_1', log_reader,log_reader_1, avg_window=avg_window)
#evaluate_logs.plot_rewards_dual('adv_1', log_reader,log_reader_1, avg_window=3*avg_window) 
#print('probs adv:')
evaluate_logs.calc_probabilities(log_reader)  # for evaluation: calculates and prints the frequencies of chosen actions (for histogram)
