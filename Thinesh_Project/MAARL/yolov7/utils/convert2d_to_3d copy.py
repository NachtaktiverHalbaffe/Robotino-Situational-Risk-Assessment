...
def apply_for_cube(xyxy,label, corners_3D,h_real,w_real,d_real):
...
def convert_2d_3d(xyxy, im0, label):
    """['sklappbox_c','sklappbox_a','box_c','box_a','chair','klappbox_c','klappbox_a','sbox_c','sbox_a']
    ['workstation_c', 'workstation_a]'"""
    ...
    """
        ...
        if label in ['sklappbox_c','sklappbox_a','klappbox_c','klappbox_a']:
            if label[0] == 'k':
                ...
                w_real = 0.48
                d_real = 0.35    
                depth, shift, depth_c, shift_c, rot,sizes, boundry, corners_3D = cube_rules(xyxy, label,h_real,w_real,d_real)
            else:
                h_real = 0.465
                w_real = 0.35
                d_real = 0.48    
