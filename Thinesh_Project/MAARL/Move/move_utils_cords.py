...
def show_acml_as_pixel():
    ...
    x3,y3,x5_3,x5_3_p,y5_3,y5_3_p = get_base_info()
...
def get_base_info():
    """This stored has all the calibration points to transfrom from pixel coords to acml coords
    @return tuple: set of calibration data used in cord changes"""
    #Workstation_5
    #position: 
    x5= -2.4831574505182648
    y5= 2.9521294984392905
