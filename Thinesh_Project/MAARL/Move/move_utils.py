...
def initialize_traj(map_ref, obstacles=None, nodes=None,start_node= None, goal_node = None, visualize=False, edges_all=None, env=None,start = [150, 117], end = [76,98]):
    """
    ...
    if not nodes:
        if env:
            ...
            traj, traj_opt, nodes, edges_all = apply_PRM_init(map_ref, obstacles,start = start, end = end)
