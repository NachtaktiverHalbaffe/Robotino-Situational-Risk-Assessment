...
A ROS1 workspace of an protoype using a situational risk assessment using multi adversarial reinforcment learning. A Robotino 4 was used as a physical robot.
